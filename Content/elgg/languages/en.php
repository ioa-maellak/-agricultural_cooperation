 ...
 */
	...
	'friends' => "Associates",
	'friends:yours' => "Your associates",
	'friends:owned' => "%s's associates",
	'friend:add' => "Add associate",
	'friend:remove' => "Remove associate",

	'friends:add:successful' => "You have successfully added %s as an associate.",
	'friends:add:failure' => "We couldn't add %s as an associate.",

	'friends:remove:successful' => "You have successfully removed %s from your associates.",
	'friends:remove:failure' => "We couldn't remove %s from your associates.",

	'friends:none' => "No associates yet.",
	'friends:none:you' => "You don't have any associates yet.",

	'friends:none:found' => "No associates were found.",

	'friends:of:none' => "Nobody has added this user as a associates yet.",
	'friends:of:none:you' => "Nobody has added you as a associate yet.",

	'friends:of:owned' => "People who have made %s an associate",

	'friends:of' => "Associates of",
	'friends:collections' => "Associate collections",
	'collections:add' => "New collection",
	'friends:collections:add' => "New associates collection",
	'friends:addfriends' => "Select associates",
	'friends:collectionname' => "Collection name",
	'friends:collectionfriends' => "Associates in collection",
