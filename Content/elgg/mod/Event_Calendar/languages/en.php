<?php
	...
	'event_calendar:group' => "Case calendar",
	...
	'event_calendar:settings:group_profile_display:title' => "Case calendar profile display (if Case calendars are enabled)",
	...
	'event_calendar:settings:autogroup:title' => "Automatically add case events for all members to their personal calendars.",
	...
	'event_calendar:settings:group_calendar:title' => "Case calendars",
	'event_calendar:settings:group_calendar:admin' => "yes, only admins and case owners can post events",
	'event_calendar:settings:group_calendar:members' => "yes, any case member can post an event",
	'event_calendar:settings:group_default:title' => "New cases should by default have a case calendar (if case calendars are enabled)",
	'event_calendar:settings:group_default:no' => "no (but admins or case owners can turn a case calendar on if desired)",
	'event_calendar:settings:group_default:yes' => "yes (but admins or case owners can turn a case calendar off if desired)",
	'event_calendar:settings:group_always_display:title' => "If case calendar is enabled, always display it (even if empty)",
	...
	'event_calendar:enable_event_calendar' => "Enable case event calendar",
...
",
	...
	'event_calendar:add_to_group:remove_group_title' => "Remove this event from case",
	'event_calendar:add_to_group:remove_group_button' => "Remove from case",
	'event_calendar:remove_from_group:success' => "Event removed from case calendar",
	'event_calendar:add_to_group:add_group_title' => "Add this event to case",
	'event_calendar:add_to_group:add_group_button' => "Add to case",
	'event_calendar:add_to_group:success' => "Event added to case calendar",
	'event_calendar:settings:add_to_group_calendar:title' => "Allow case admins to add any existing event to a group calendar",
		
	'event_calendar:group_breadcrumb' => "Cases calendar",
	'event_calendar:no_group' => "There is no such case.",
	...
	'event_calendar:add_to_group_members:success' => "This event has been added to the personal calendars of all case members.",
	'event_calendar:add_to_group_members:error' => "Error: could not add this event to the personal calendars of case members.",
	'event_calendar:remove_from_group_members:success' => "This event has been removed from the personal calendars of all case members.",
	'event_calendar:remove_from_group_members:error' => "Error: could not remove this event from the personal calendars of case members.",
