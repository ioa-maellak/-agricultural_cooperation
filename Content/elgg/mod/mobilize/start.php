...
function mobilize_setup_handler() {
	...
	//	'text' => elgg_echo('mobilize:copyright') . $year . elgg_echo(' Elggzone'),          AlexF:Changed this to remove the Elggzone at the bottom bar
		'priority' => 1,
		'section' => 'alt',
	));
	...
	$greekflag_url = elgg_get_site_url() . "_graphics/greekflag.gif";
	$europeanflag_url = elgg_get_site_url(). "_graphics/europeanflag.gif";
	$albanianflag_url = elgg_get_site_url(). "_graphics/albanianflag.gif";
	$href = "http://www.interreg4c.eu/";
	
	/*
	elgg_register_menu_item('footer', array(
		'name' => 'disclaimer',
		'text' => elgg_echo('
		<div style="text-align:center"> The project is co-funded by the European Union and by National funds of Greece & Albania</div>
		<div style="text-align:center">under the IPA Cross-Border PROGRAMME "Greece-Albania 2007-2013"</div>
		<div style="text-align:center"><img src='.$greekflag_url.' height="30" width="50" /> <img src='.$europeanflag_url.' height="30" width="50"/> <img src='.$albanianflag_url.' height="30" width="50"/></div>
		'),
		'priority' => 1,
		'section' => 'alt',
	));		
