...
- MODDED: you can now use elgg_echos in the menus title. (Ex.: [item:site] )
...
- setSelected on submenu and parent + partial selection + or subitem selected state.election + or subitem selected state.