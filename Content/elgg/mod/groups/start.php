...
function groups_init() {
	...
	// add group activity tool option //AlexF: commented the next 2 lines
	...
	//elgg_register_plugin_hook_handler('register', 'menu:owner_block', 'groups_activity_owner_block_menu'); //AlexF: Commended by AlexF
...
function discussion_init() {
	...
	//add_group_tool_option('forum', elgg_echo('groups:enableforum'), true); //AlexF: Commented by AlexF
